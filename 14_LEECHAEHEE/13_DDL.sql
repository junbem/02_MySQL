...
) ENGINE = INNODB COMMENT '상품테이블'; -- 바로 COMMIT 된다.
...
(   id INT PRIMARY KEY AUTO_INCREMENT COMMENT VARCHAR(255) COMMENT '상품명',
...
-- ALTER
-- ================================
-- 테이블에 추가/변경/수정/삭제하는 모든 것은 ALTER 명령어를 사용해서 적용된다.
