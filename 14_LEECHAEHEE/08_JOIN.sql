...
FROM
     tbl_menu a
INNER JOIN
     tbl_category b ON a.category_code = b.category_code; -- 가상 테이블 생성, 인라인 뷰라고도 함
...
SELECT
      *
FROM employee a
JOIN department b ON a.DEPT_CODE = b.DEPT_ID; -- NULL 미포함

SELECT
      *
FROM employee a
LEFT JOIN department b ON a.DEPT_CODE = b.DEPT_ID; -- NULL 포함
...
LEFT JOIN nation e on d.NATIONAL_CODE = e.NATIONAL_CODE; -- 다중 JOIN
