...
-- 컬럼을 명시하면 INSERT시 데이터의 순서를 바꾸는것이 가능하다.
INSERT INTO
...
-- 다만 MySQL은 Oracle과 달리 update나 delete시 자기 자신 테이블의 데이터를 사용할 시
-- 1093 에러가 발생한다.
UPDATE
    tbl_menu
   SET
...
-- 되돌릴 지점이 없이 바로 삭제 (모든 데이터를 지워야할때 빠르게 사용)
