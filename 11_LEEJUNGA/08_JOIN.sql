...
# INNER JOIN tbl_category b ON b.category_code = a.category_code;
JOIN tbl_category b ON b.category_code = a.category_code;
...
LEFT JOIN nation e ON e.NATIONAL_CODE = d.LOCAL_CODE;
