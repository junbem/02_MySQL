...
-- 커럼을 명시하면 INSERT시 데이터의 순서를 바꾸는 것도 가능하다.
...
UPDATE
   ...
   SET
        category_code = 10
      , menu_name = '매생이쉐이크' -- 여러 개의 값을 동시에 수정할 경우 콤마
 WHERE
        menu_code = 25;
...
-- LIMIT를 활용한 행삭제(offset 지정은 안 된다.)
DELETE
  FROM tbl_menu
 ORDER BY menu_price
 LIMIT 2;
...
INSERT INTO tbl_menu VALUES (17, '참기름맛소주', 7000, 10, 'Y');

REPLACE INTO tbl_menu VALUES (17, '참기름맛소주', 7000, 10, 'Y');

-- INTO 생략 가능
REPLACE INTO tbl_menu VALUES (17, '들기름맛소주', 7000, 10, 'Y');
