...
INSERT INTO ENCORE_BANK VALUES (id 456, name '신사임당', balance 1000000);
...
VALUES (menu_code null, menu_name '딸기맛 감자탕', menu_price 9500, category_code 4, orderable_status 'Y')

INSERT INTO tbl_menu
VALUES (menu_code null, menu_name '딸기맛 감자탕', menu_price 9500, category_code 4, orderable_status 'Y')

INSERT INTO tbl_menu(MENU_CODE, MENU_NAME, MENU_PRICE, CATEGORY_CODE, ORDERABLE_STATUS)
VALUE (menu_name '민트초코맛파전', menu_price 10000, category_code 4, orderable_status 'Y')
