...
FROM tbl_menu
WHERE
    menu_name BETWEEN  '가' AND '마' -- 이름을 뽑아온후 가격 기준으로 정렬
ORDER By 2;
...
FROM tbl_menu
WHERE
    menu_name NOT BETWEEN  '10000' AND '25000';
...
-- 2. 개수에 따라 문자 1개를 의미한다 _가 3개라면 문자 3개를 의미한다. ex) ___a면 3글자뒤에 a가 오는 문자
